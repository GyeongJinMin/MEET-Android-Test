...
import kr.ac.hansung.stt.util.RetrofitService;
...
public class SttThread extends Thread {
    ...
    private void publishTextData(String text) {
        mqttClient.publish(mqttClient.getTopic_text(), text);
    }
}